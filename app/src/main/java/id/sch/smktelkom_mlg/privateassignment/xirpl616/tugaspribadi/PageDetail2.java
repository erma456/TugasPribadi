...
public class PageDetail2 extends AppCompatActivity {

    private static final String URL_DATA = "https://api.themoviedb.org/3/movie/upcoming?api_key=0bc12e9b8cdad4c2fdb7ad83354e7055";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewHeading = (TextView) findViewById(R.id.textViewHeading2);
        textViewDesc = (TextView) findViewById(R.id.textViewDesc2);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL_DATA, new Response.Listener<String>() {
            ...
            public void onResponse(String s) {
                ...
                try {
                    ...
                    textViewReview.setText("Release Date : " + o.getString("release_date"));
                    url = o.getJSONObject("link").getString("url");
                    Glide
                            .with(PageDetail2.this)
