...
public class PageFragment2 extends Fragment {
    ...
    public List<Page2ListItem> listItems;
...
//        for (int i = 0; i <= 5; i++) {
//            Page2ListItem listItem = new Page2ListItem(
//                    "",
//                    "Title" + (i + 1),
//                    "Lorem ipsum"
//            );
...
//        }
        adapter = new Page2Adapter(listItems, getActivity());
                    ...
                    public void onResponse(String s) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                Page2ListItem item = new Page2ListItem(
                            ...
                            adapter = new Page2Adapter(listItems, getActivity().getApplication());
                            recyclerView.setAdapter(adapter);
